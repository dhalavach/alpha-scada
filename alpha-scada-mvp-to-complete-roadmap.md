# Alpha SCADA: MVP To Complete Platform Roadmap
...
- MVP proves value for one Combined Heat and Power Unit unit.
...
|---|---|---|---|
| 0 | Discovery | Confirm Combined Heat and Power Unit controller, tags, gateway, demo goals | Yes |
| 1 | Simple MVP | One Combined Heat and Power Unit monitored end-to-end with alarms, trends, report | Yes |
...
- Actual Combined Heat and Power Unit controller.
...
- We can read live or simulated Combined Heat and Power Unit data.
- MVP scope is frozen.
...
```text
Combined Heat and Power Unit controller
...
- Combined Heat and Power Unit simulator.
...
- Login.
- Combined Heat and Power Unit overview.
- Live tag list.
- Trends.
- Active alarms.
- Monthly report.
...
- A live or simulated Combined Heat and Power Unit can be monitored from browser.
- Alarms work.
- Trends work.
- Monthly report works.
- Demo can be shown to Alpha/customer.
...
- Combined Heat and Power Unit tag template.
...
[alpha-open-scada-architecture-plan.md](/Users/kopfmann/Documents/scada/alpha-open-scada-architecture-plan.md)
...
- Combined Heat and Power Unit asset template versioning.
...
- Platform can support Alpha plus first customer tenant with strict isolation.
...
| UI | Combined Heat and Power Unit screens | Combined Heat and Power Unit + pilot ops screens | Fleet/site/tenant screens |
...
[alpha-open-scada-simple-plan.md](/Users/kopfmann/Documents/scada/alpha-open-scada-simple-plan.md)
