...
export type Tag = { tagId: string; tenantId: string; unitId: string; tagKey: string; name: string; subsystem: string; value: number | null; engineeringUnit: string; quality: string; timestampUtc: string | null };
